...
class ReportController {
    static async createReport(req, res) {
        try {
            const { location, severity, outage_type, description } = req.body;
    ...
    static async getMyReports(req, res) {
        try {
            ...
            ResponseHandler.success(res, 'Reports retrieved successfully', reports);
        } catch (error) {
            ResponseHandler.error(res, error.message, 500);
        }
    }
    ...
    static async getAllReports(req, res) {
        try {
            ...
            ResponseHandler.success(res, 'All reports retrieved successfully', reports);
        } catch (error) {
            ResponseHandler.error(res, error.message, 500);
        }
    }
    ...
    static async getReportById(req, res) {
        try {
            ...
            ResponseHandler.success(res, 'Report retrieved successfully', report);
        } catch (error) {
            ResponseHandler.error(res, error.message, 500);
        }
    }
    ...
    static async updateReportStatus(req, res) {
        try {
            ...
            ResponseHandler.success(res, 'Report status updated successfully', report);
        } catch (error) {
            ResponseHandler.error(res, error.message, 500);
        }
    }
    ...
    static async getDashboardStats(req, res) {
        try {
            ...
            ResponseHandler.success(res, 'Dashboard stats retrieved successfully', data);
        } catch (error) {
            ResponseHandler.error(res, error.message, 500);
        }
    }
